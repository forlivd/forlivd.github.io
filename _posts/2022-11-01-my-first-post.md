...
todo : email 등 contact 작성 및 연결, ReadME 수정, about 작성
...
todo : 클린 아키텍쳐에서는 어느 위치에서 chchedIn된 데이터를 생성해야 할지 좀 더 고민이 필요하다.
...
todo : 나중에 서버 담당자와 한 번 할 수 있는 모든 방식으로 에러를 발생시켜 보기로 했다.
...
todo : 해당 연습 페이지 삭제 또는 수정, todo 같은 거 모아 볼 수 있게 하는 기능 찾아보기
